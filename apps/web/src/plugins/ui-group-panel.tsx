...
export const uiGroupPanelPlugin: Plugin = {
    name: "ui-group-panel",
    description: "群管理面板(成员 / 公告 / 禁言 / 解散)",
    inject: ["ui", "rpc", "auth", "friends", "presence"],
    async apply(ctx) {
        ...
        const GroupPanel = () => {
            ...
            const privileged =
                info.myRole === "owner" || info.myRole === "admin";
