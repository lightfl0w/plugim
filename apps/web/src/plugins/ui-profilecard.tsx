...
export const uiProfileCardPlugin: Plugin = {
    name: "ui-profile-card",
    description: "点击头像弹出用户资料卡",
    ...
    async apply(ctx) {
        ...
        const ProfileCard = () => {
            ...
            const isOutgoing =
                !isSelf &&
                (relation?.outgoing.includes(card.username) ?? false);
            const isIncoming =
                !isSelf &&
                (relation?.incoming.includes(card.username) ?? false);
            ...
            return (
                ...
                >
                    <div className="h-14 bg-gradient-to-r from-primary/60 to-primary/25" />
